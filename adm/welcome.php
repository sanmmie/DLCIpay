...
if(isset($_POST['welc'])){
	...
	mysqli_query($wole,"update setup set webhome='$welc' where id=1");
	$_SESSION[$sessname7]="<font color=blue>Home Text updated!</font>";		
	header("location:$weburl/adm/welcome");
}
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-body">
         <?php echo $msg ;?>
		 <form method="post" action="welcome" id="mform">			
          <div class="form-group">
            <label for="exampleInputEmail1">Home Page Text</label>
			<textarea class="form-control" name="welc"  rows="10" id="welc"><?php echo $webhome ;?></textarea>
          </div>
		   <div class="form-group">
