...
if(isset($_POST['welc'])){
	...
	mysqli_query($wole,"update announce set news='$welc' where id=1");
	$_SESSION[$sessname7]="<font color=blue>Announcement updated!</font>";		
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-body">
         <?php echo $msg ;?>
		 <form method="post" action="news" id="mform">			
          <div class="form-group">
		  This information will be displayed on the user's dashboard<br>
            <label for="exampleInputEmail1">Announcement</label>
			<textarea class="form-control" name="welc"  rows="10" id="welc"><?php echo $information ;?></textarea>
          </div>
		   <div class="form-group">
